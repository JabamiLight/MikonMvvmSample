package com.mikon.basiccomponent.toast;
...
import com.mikon.basiccomponent.utils.ScreenUtils;
...
public class ToastUtils {
	...
	public static void show(Context context, CharSequence text, int type) {
		...
		if (type == NO) {
			...
			toast.setGravity(Gravity.BOTTOM, 0, ScreenUtils.dip2px(context, 50));
